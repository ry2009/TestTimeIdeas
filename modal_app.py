...
def run_bench():
    ...
    out.append(_run("python tests/bench_gradgrad.py --b 2 --h 2 --t 128 --d 64 --dtype fp16 --bwd_mode save_p_triton_bwd"))
    out.append(_run("python tests/bench_gradgrad.py --b 2 --h 2 --t 128 --d 64 --dtype fp16 --bwd_mode save_p_triton_full"))
    ...
    out.append(_run("python tests/bench_gradgrad.py --b 1 --h 4 --t 512 --d 128 --dtype fp16 --bwd_mode save_p_triton_bwd"))
    out.append(_run("python tests/bench_gradgrad.py --b 1 --h 4 --t 512 --d 128 --dtype fp16 --bwd_mode save_p_triton_full"))
    ...
    out.append(_run("python tests/bench_gradgrad.py --b 1 --h 4 --t 1024 --d 128 --dtype fp16 --bwd_mode save_p_triton_bwd"))
    out.append(_run("python tests/bench_gradgrad.py --b 1 --h 4 --t 1024 --d 128 --dtype fp16 --bwd_mode save_p_triton_full"))
    ...
    out.append(_run("python tests/bench_gradgrad_sweep.py --b 1 --h 1 --d 64 --dtype fp16 --iters 8 --warmup 2 --repeats 4 --bwd_mode save_p_triton_full --ts 512,1024,2048,4096,8192,16384 --out /tmp/gradgrad_sweep.csv"))
    out.append(_run("cat /tmp/gradgrad_sweep.csv"))
    return "\n".join(out)
